...
// RUN: %cxx-langstat --analyses=msa -emit-features -in %S/Deduplication1.ast -in %S/Deduplication2.ast -outdir %S --
// RUN: %cxx-langstat --analyses=msa -emit-statistics -in %S/Deduplication1.ast.json -in %S/Deduplication2.ast.json -out %S/overall_stats.tmp --
